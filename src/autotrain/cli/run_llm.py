...
FIELD_GROUPS = {
    ...
    "rl_loss_type": "Reinforcement Learning (GRPO)",
    "rl_mask_truncated_completions": "Reinforcement Learning (GRPO)",
...
FIELD_SCOPES = {
    ...
    "rl_loss_type": ["grpo"],
    "rl_mask_truncated_completions": ["grpo"],
    "use_vllm": ["grpo"],
    "vllm_mode": ["grpo"],
